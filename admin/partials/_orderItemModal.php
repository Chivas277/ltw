    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(111 202 203);">
                <h5 class="modal-title" id="orderItem<?php echo $orderid; ?>">Chi tiết đơn hàng (<b>Mã đơn hàng: <?php echo $orderid; ?></b>)</h5>
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <th scope="col" class="border-0 bg-light">
                                    <div class="px-3">Tên sản phẩm</div>
                                </th>
                                <th scope="col" class="border-0 bg-light">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        $itemsql = "SELECT * FROM `flower` WHERE pizzaId = $pizzaId";
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/FlowerStore/img/pizza-'.$pizzaId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$pizzaName. '</h5><span class="text-muted font-weight-normal font-italic d-block"> ' .$pizzaPrice. ' VNĐ</span>
                                                    </div>
                                                    </div>
                                                </th>
